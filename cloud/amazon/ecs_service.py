...
---
module: ecs_service
short_description: Manages services in ECS
description:
...
def main():
    ...
    deployment_configuration = type_mapper.map_complex_type(module.params['deployment_configuration'], DEPLOYMENT_CONFIGURATION_TYPE_MAP)
                ...
                if module.params['deployment_configuration'] is None:
                    ...
                    if not ("minimumHealthyPercent" in deployment_configuration and
                        ...
                        module.fail_json(msg="To use deployment_configuration "
                                             "you must specify both minimum_healthy_percent "
                                             "and maximum_percent.")
                if update:
                    # update required
